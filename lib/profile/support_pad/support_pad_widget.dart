...
import 'support_pad_model.dart';
export 'support_pad_model.dart';

class SupportPadWidget extends StatefulWidget {
  const SupportPadWidget({Key? key}) : super(key: key);

  @override
  _SupportPadWidgetState createState() => _SupportPadWidgetState();
}

class _SupportPadWidgetState extends State<SupportPadWidget>
    with TickerProviderStateMixin {
  late SupportPadModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SupportPadModel());
